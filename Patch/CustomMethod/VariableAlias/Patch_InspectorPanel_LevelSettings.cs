...
namespace RDEditorPlus.Patch.CustomMethod.VariableAlias
{
    internal static class Patch_InspectorPanel_LevelSettings
    {
        ...
        private static class Awake
        {
            ...
            {
                GameObject buttonGO = new($"Mod_{MyPluginInfo.PLUGIN_GUID}_VariableAliasesButton");
        ...
        private static void OnClick() => VariableAliasPanelHolder.Instance.Toggle(show: true);
