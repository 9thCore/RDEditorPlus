...
namespace RDEditorPlus.Functionality.NodeFunctionality.NodeEditor.Nodes.Variable.RDLevelNode
{
    public class RDLevelNodeVariable : NodeVariable<RDLevelNodeVariable, RDLevelFile>
    {
        ...
        {
            CurrentValue = new RDLevelFile(path);
        ...
        protected override void SetInitialValue(object initialValue)
        {
            ...
            base.SetInitialValue(default(RDLevelFile));
        }
        ...
        public static GameObject VariablePrefab
        {
            get
            {
                if (variablePrefab == null)
                {
                    ...
                    var variable = variablePrefab.GetComponent<RDLevelNodeVariable>();
                    variable.type = Node.Type.RDLevelFile;
