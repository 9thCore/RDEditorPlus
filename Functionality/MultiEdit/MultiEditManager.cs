...
namespace RDEditorPlus.Functionality.MultiEdit
{
    public class MultiEditManager
    {
        private static MultiEditManager instance;
        public static MultiEditManager Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new MultiEditManager();
                }
        ...
        public void ApplyConditionalButtonThings(Conditionals conditionals)
        {
            foreach (ConditionalInfo info in scnEditor.instance.allConditionals.Zip(conditionals.conditionalButtons, (c, b) => new ConditionalInfo(b, c)))
            {
